          ...
          <div className="row row-cols-1 row-cols-sm-1 row-cols-md-2 g-4">
            <div className="col my-2">
              <div className="card border-outline shadow-sm">
                <img src={pokedex_gen} alt="pokedex generation image" className="bd-placeholder-img card-img-top grey-scale project-image" />
                <div className="card-body">
                  <p className="card-text">View pokedex entries specific to their generations!</p>
                  <div className="d-flex justify-content-between align-items-center">
                    <div className="btn-group">
                      <a href="https://pokedexgenerationz.netlify.app/" target="_blank" rel="noopener noreferrer">
            ...
            <div class="col my-2">
              <div class="card border-outline shadow-sm">
                <img src={anivault} alt="roster radar screenshot" className="bd-placeholder-img card-img-top grey-scale project-image" />
                <div class="card-body">
                  <p class="card-text"> An application to discover random animes based on a genre.</p>
                  <div class="d-flex justify-content-between align-items-center">
                    <div class="btn-group">
                      <a href="https://anivault.onrender.com/" target="_blank" rel="noopener noreferrer">
                        <button type="button" className="btn btn-sm btn-outline-secondary">View</button>
                      </a>
            ...
            <div class="col my-2">
              <div class="card border-outline shadow-sm">
                <img src={graphql_refactor} alt="readme_gen project image" className="bd-placeholder-img card-img-top grey-scale project-image" />
                <div class="card-body">
                  <p class="card-text">An existing app that has been refactored to utilize a GraphQL layer and a MongoDB database.</p>
                  <div class="d-flex justify-content-between align-items-center">
                    <div class="btn-group">
                      <a href="https://mern-graphql-refactor-3gat.onrender.com/" target="_blank" rel="noopener noreferrer">
                        <button type="button" className="btn btn-sm btn-outline-secondary">View</button>
                      </a>
